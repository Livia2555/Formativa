...
urlpatterns = [
    ...
    path('disciplinas/', view=views.DisciplinaListCreatAPIView.as_view(), name='listar_criar_disciplina'),
    path('disciplinas/<int:pk>/', view=views.DisciplinaRetrieveUpdateDestroyAPIView.as_view(), name='atualizar_deletar_disciplina'),
